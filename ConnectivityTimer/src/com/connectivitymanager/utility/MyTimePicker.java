...
public class MyTimePicker extends LinearLayout {
	...
	public MyTimePicker(Context context, AttributeSet attrs) {
		...
		hourList.setAdapter(new ArrayAdapter<String>(context,
				R.layout.spinner_item, context.getResources().getStringArray(
		...
		Button hourSubtractButton =
				(Button) findViewById(R.id.hour_subtract_button);
		...
		minuteList.setAdapter(new ArrayAdapter<String>(context,
				R.layout.spinner_item, context.getResources().getStringArray(
						R.array.scheduler_minute_array)));
		...
		Button minuteSubtractButton =
				(Button) findViewById(R.id.minute_subtract_button);
	 ...
	 */
	public int getHour() {
		return Integer.parseInt(hourList.getItemAtPosition(
				hourList.getFirstVisiblePosition()).toString());
	}
	...
	public int getMinute() {
		return Integer.parseInt(minuteList.getItemAtPosition(
				minuteList.getFirstVisiblePosition()).toString());
	}
	...
	public void setHour(int value) {
		if (value < 24 && value >= 0) {
			...
			throw new IndexOutOfBoundsException(
					"Incorrect hour number, the hours of the day are numbered 0 through 23");
		}
	}

	/**
	 * Sets the minute selection to the item corresponding to the parameter
	 * value
	 * 
	 * @param value
	 *            the desired minute
	...
	public void setMinute(int value) {
		if (value < 60 && value >= 0) {
			...
			throw new IndexOutOfBoundsException(
					"Incorrect minute number, the minutes are numbered 0 through 59");
		}
	}
